...
+ (void)_bulkUpdateAnalysisStatesTo:(int)arg1 predicate:(id)arg2 errror:(id*)arg3;
...
+ (void)markStatesProcessedForWorkerType:(short)arg1 error:(id*)arg2;
...
+ (void)resetPendingStatesWithError:(id*)arg1;
