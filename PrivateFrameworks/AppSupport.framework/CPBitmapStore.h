...
- (void)dealloc;
- (bool)findImageWithKey:(id)arg1 inGroup:(id)arg2 andInfo:(struct _img { id x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned char x5; }*)arg3;
...
- (void*)openAndMmap:(id)arg1 withInfo:(struct _img { id x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned char x5; }*)arg2;
- (void)purge;
- (void)removeImagesInGroups:(id)arg1;
- (void)removeImagesInGroups:(id)arg1 completion:(id /* block */)arg2;
- (bool)saveImageWithKey:(id)arg1 inGroup:(id)arg2 andInfo:(struct _img { id x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned char x5; }*)arg3;
