...
@property (nonatomic, retain) NSMutableSet *disableUpdateReasons;
...
@property (nonatomic, retain) NSMutableSet *pendingObservedCharacteristics;
...
- (id)_reloadItemProvidersWithInvalidationReasons:(id)arg1 updateItems:(id)arg2 allowCharacteristicReads:(bool)arg3 senderSelector:(SEL)arg4 updatedHome:(id)arg5;
...
- (id)_updateResultsForItems:(id)arg1 allowCharacteristicReads:(bool)arg2 senderSelector:(SEL)arg3;
...
- (id)pendingObservedCharacteristics;
...
- (void)setDisableUpdateReasons:(id)arg1;
...
- (void)setPendingObservedCharacteristics:(id)arg1;
