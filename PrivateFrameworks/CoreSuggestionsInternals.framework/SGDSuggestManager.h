...
- (void)_suggestionsFromMessage:(id)arg1 options:(unsigned long long)arg2 dissectIfNecessary:(bool)arg3 completionHandler:(id /* block */)arg4;
- (void)_suggestionsFromMessageWithIdentifier:(id)arg1 source:(id)arg2 options:(unsigned long long)arg3 completion:(id /* block */)arg4 providedBy:(id /* block */)arg5 dissectIfNecessary:(bool)arg6;
