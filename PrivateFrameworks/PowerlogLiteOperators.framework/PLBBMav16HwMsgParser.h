...
@interface PLBBMav16HwMsgParser : PLBBMav13HwMsgParser {
    ...
    struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4[17]; unsigned int x5[12]; unsigned int x6[6]; unsigned int x7[3]; unsigned int x8[6]; unsigned int x9[2][7]; unsigned int x10[2][6]; unsigned int x11[2][6]; unsigned int x12[5]; unsigned int x13[3]; unsigned int x14; unsigned long long x15[8]; unsigned int x16; struct { unsigned char x_17_1_1; unsigned char x_17_1_2; unsigned char x_17_1_3[2]; unsigned char x_17_1_4[2]; } x17; } * _rfEnhLTEMav16;
...
@property (nonatomic) struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4[17]; unsigned int x5[12]; unsigned int x6[6]; unsigned int x7[3]; unsigned int x8[6]; unsigned int x9[2][7]; unsigned int x10[2][6]; unsigned int x11[2][6]; unsigned int x12[5]; unsigned int x13[3]; unsigned int x14; unsigned long long x15[8]; unsigned int x16; struct { unsigned char x_17_1_1; unsigned char x_17_1_2; unsigned char x_17_1_3[2]; unsigned char x_17_1_4[2]; } x17; }*rfEnhLTEMav16;
...
- (void)setRfEnhLTEMav16:(struct { unsigned int x1; unsigned int x2; unsigned int x3; unsigned int x4[17]; unsigned int x5[12]; unsigned int x6[6]; unsigned int x7[3]; unsigned int x8[6]; unsigned int x9[2][7]; unsigned int x10[2][6]; unsigned int x11[2][6]; unsigned int x12[5]; unsigned int x13[3]; unsigned int x14; unsigned long long x15[8]; unsigned int x16; struct { unsigned char x_17_1_1; unsigned char x_17_1_2; unsigned char x_17_1_3[2]; unsigned char x_17_1_4[2]; } x17; }*)arg1;
