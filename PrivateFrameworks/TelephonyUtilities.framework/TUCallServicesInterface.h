...
- (void)requestInitialStateIfNecessaryAndSendNotifications:(bool)arg1 completionHandler:(id /* block */)arg2;
- (void)requestInitialStateIfNecessaryAndWait;
- (void)requestInitialStateIfNecessaryWithCompletionHandler:(id /* block */)arg1;
