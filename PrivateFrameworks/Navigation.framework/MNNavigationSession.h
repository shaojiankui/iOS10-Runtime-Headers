...
@interface MNNavigationSession : NSObject <GEONavigationObserver, MNGuidanceManagerDelegate, MNLocationManagerObserver, MNLocationTrackerDelegate, MNNavigationAudioSessionDelegate, MNTimeAndDistanceUpdaterDelegate, MNTracePlayerObserver> {
