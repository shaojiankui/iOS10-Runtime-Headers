...
- (void)remote_fetchSharedDataWithCompletion:(id /* block */)arg1;
...
- (void)remote_sendInviteRequestToDestination:(id)arg1 addressBookGUID:(id)arg2 serviceIdentifier:(id)arg3 completion:(id /* block */)arg4;
