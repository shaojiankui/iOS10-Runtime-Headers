...
@interface HKDataUnit : NSObject <NSCopying> {
    unsigned long long  _associatedSampleStatisticsOptions;
...
@property (nonatomic, readonly) unsigned long long associatedSampleStatisticsOptions;
...
- (unsigned long long)associatedSampleStatisticsOptions;
