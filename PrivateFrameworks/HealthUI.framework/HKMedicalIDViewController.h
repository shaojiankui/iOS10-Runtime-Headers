...
@interface HKMedicalIDViewController : HKViewController <HKEmergencyCardDeletionDelegate, HKEmergencyCardRowHeightChangeDelegate, HKMedicalIDViewControllerDelegate, UITableViewDataSource, UITableViewDelegate> {
    bool  _allowsEditing;
...
- (id)initInEditMode:(bool)arg1 inBuddy:(bool)arg2;
