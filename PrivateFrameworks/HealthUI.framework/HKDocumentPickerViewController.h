...
@interface HKDocumentPickerViewController : HKTableViewController <HKDocumentPickerTableViewCellDelegate> {
    NSSet * _allSamples;
...
- (bool)_isPrompting;
- (id)_keyForDocumentAuthWithCount:(long long)arg1;
- (bool)_needsSampleRequestDescription;
- (id)_tableHeaderView;
- (id)allSamples;
- (id)delegate;
- (void)documentPickerTableViewCellDidChangeValue:(id)arg1;
- (id)enabledSamples;
