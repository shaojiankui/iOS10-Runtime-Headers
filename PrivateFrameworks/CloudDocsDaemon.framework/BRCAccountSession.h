...
- (id)__getOrCreateAppLibrary:(id)arg1 ownerName:(id)arg2 rowID:(id)arg3 createOnDisk:(bool)arg4 alreadyExistsAndResumed:(bool*)arg5 zoneID:(id)arg6 withClientZone:(id)arg7;
...
- (bool)createAppLibraryOnDisk:(id)arg1 createdRoot:(bool*)arg2 createdDocuments:(bool*)arg3;
...
- (bool)createSharedAppLibraryOnDiskWithMangledID:(id)arg1 createdRoot:(bool*)arg2;
