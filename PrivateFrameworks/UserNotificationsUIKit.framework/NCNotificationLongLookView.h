...
@interface NCNotificationLongLookView : NCAnimatableBlurringView <NCCustomContentContainingLookView, NCNotificationStaticContentAccepting, UIScrollViewDelegate> {
