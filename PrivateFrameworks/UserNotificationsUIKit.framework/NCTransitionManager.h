...
- (void).cxx_destruct;
- (void)_beginInteractivePresentation:(bool)arg1 ifPossibleForInitiator:(long long)arg2;
- (void)_beginInteractivePresentation:(bool)arg1 ifPossibleForInitiator:(long long)arg2 completion:(id /* block */)arg3;
