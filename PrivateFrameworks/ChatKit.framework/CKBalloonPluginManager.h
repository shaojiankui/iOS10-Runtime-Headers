...
@property (nonatomic, retain) NSDictionary *pluginEnabledMap;
...
@property (nonatomic, readonly) NSArray *visiblePlugins;
@property (nonatomic, readonly) NSArray *visibleSwitcherPlugins;
...
- (void)setPluginEnabledMap:(id)arg1;
