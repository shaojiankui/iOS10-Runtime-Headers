...
- (id)hapticsGenerator;
- (id)initWithChatItem:(id)arg1 interfaceActions:(id)arg2 gradientReferenceView:(id)arg3 isGroupConversation:(bool)arg4 showActionMenu:(bool)arg5 pluginBalloonSnapshot:(id)arg6 delegate:(id)arg7;
