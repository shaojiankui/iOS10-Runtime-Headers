...
@interface CKMessageEntryView : UIView <CKActionMenuControllerDelegate, CKActionMenuGestureRecognizerButtonDelegate, CKAudioRecorderDelegate, CKInlineAudioReplyButtonDelegate, CKMessageEntryContentViewDelegate, CKMessageEntryRecordedAudioViewDelegate, CKMessageEntryViewStyleProtocol, UIGestureRecognizerDelegate, _UIBackdropViewGraphicsQualityChangeDelegate> {
    ...
    bool  _entryFieldUpdaterDisableCalloutsValue;
...
@property (nonatomic) bool entryFieldUpdaterDisableCalloutsValue;
...
+ (id)audioButtonImage;
+ (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })contentViewInsetsForMarginInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1 shouldShowPhotoButton:(bool)arg2 shouldShowCharacterCount:(bool)arg3 shouldCoverSendButton:(bool)arg4;
+ (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })coverViewInsetsForMarginInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1 shouldShowPhotoButton:(bool)arg2 shouldShowCharacterCount:(bool)arg3;
+ (struct UIEdgeInsets { double x1; double x2; double x3; double x4; })coverViewInsetsForMarginInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1 shouldShowPhotoButton:(bool)arg2 shouldShowCharacterCount:(bool)arg3 shouldCenterCharacterCount:(bool*)arg4;
...
- (void)_updateEntryView:(bool)arg1 disableCallouts:(bool)arg2;
...
- (id)browserButton;
- (void)browserButtonLongPressed:(id)arg1;
...
- (bool)entryFieldUpdaterDisableCalloutsValue;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 marginInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 shouldAllowImpact:(bool)arg3 shouldShowSendButton:(bool)arg4 shouldShowSubject:(bool)arg5 shouldShowPhotoButton:(bool)arg6 shouldShowCharacterCount:(bool)arg7;
...
- (void)setEntryFieldCollapsed:(bool)arg1 animated:(bool)arg2 disableCallouts:(bool)arg3;
...
- (void)setEntryFieldUpdaterDisableCalloutsValue:(bool)arg1;
...
- (void)updateEntryView:(bool)arg1;
