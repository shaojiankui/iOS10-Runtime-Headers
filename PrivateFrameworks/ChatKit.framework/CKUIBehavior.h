...
@property (nonatomic, readonly) NSArray *avatarPancakeOffsets;
...
- (double)balloonMaxWidthForTranscriptWidth:(double)arg1 marginInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg2 shouldShowPhotoButton:(bool)arg3 shouldShowCharacterCount:(bool)arg4 shouldCoverSendButton:(bool)arg5;
