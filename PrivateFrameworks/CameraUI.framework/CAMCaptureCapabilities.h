...
@property (nonatomic, readonly) double _backVideoModeMaximumVideoZoomFactor;
@property (nonatomic, readonly) double _frontCaptureInterval;
@property (nonatomic, readonly) double _frontVideoModeMaximumVideoZoomFactor;
...
- (double)maximumVideoZoomFactorForMode:(long long)arg1 device:(long long)arg2 videoConfiguration:(long long)arg3;
