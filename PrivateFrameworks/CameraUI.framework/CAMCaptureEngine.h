...
- (void)_didFinishProcessingStillImageSurface:(struct __IOSurface { }*)arg1 ofSize:(unsigned long long)arg2 withPreviewSurface:(struct __IOSurface { }*)arg3 ofSize:(unsigned long long)arg4 metadata:(id)arg5 forSettings:(id)arg6 error:(id)arg7;
...
- (id)backCameraDevice;
- (id)cameraDevice;
- (void)captureOutput:(id)arg1 didCapturePhotoForSettings:(id)arg2;
- (void)captureOutput:(id)arg1 didDropSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg2 fromConnection:(id)arg3;
- (void)captureOutput:(id)arg1 didFinishCaptureForSettings:(id)arg2 error:(id)arg3;
- (void)captureOutput:(id)arg1 didFinishProcessingLivePhotoToMovieFileAtURL:(id)arg2 withDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 photoDisplayTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4 forSettings:(id)arg5 error:(id)arg6;
- (void)captureOutput:(id)arg1 didFinishProcessingOriginalPhotoSurface:(struct __IOSurface { }*)arg2 ofSize:(unsigned long long)arg3 withPreviewSurface:(struct __IOSurface { }*)arg4 ofSize:(unsigned long long)arg5 metadata:(id)arg6 forSettings:(id)arg7 error:(id)arg8;
...
- (void)captureOutput:(id)arg1 didFinishRecordingLivePhotoMovieForEventualFileAtURL:(id)arg2 settings:(id)arg3;
...
- (void)captureOutput:(id)arg1 willCapturePhotoForSettings:(id)arg2;
