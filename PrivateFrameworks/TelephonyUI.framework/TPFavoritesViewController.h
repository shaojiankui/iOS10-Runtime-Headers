...
@interface TPFavoritesViewController : UICollectionViewController {
    NSMutableArray * _avatarViewControllerPool;
    CNAvatarViewControllerSettings * _avatarViewControllerSettings;
    NSMutableDictionary * _avatarViewControllers;
...
@property (nonatomic, readonly) NSMutableArray *avatarViewControllerPool;
@property (nonatomic, retain) CNAvatarViewControllerSettings *avatarViewControllerSettings;
@property (nonatomic, readonly) NSMutableDictionary *avatarViewControllers;
...
- (void).cxx_destruct;
- (id)avatarViewControllerPool;
- (id)avatarViewControllerSettings;
- (id)avatarViewControllers;
