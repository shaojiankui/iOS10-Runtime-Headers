...
@interface SBFWallpaperView : UIView <SBFLegibilitySettingsProvider, _UISettingsKeyObserver> {
    ...
    bool  _darkensContentsToEnsureLegibility;
...
@property (nonatomic) bool darkensContentsToEnsureLegibility;
...
- (bool)darkensContentsToEnsureLegibility;
- (void)dealloc;
- (id)delegate;
...
- (void)setDarkensContentsToEnsureLegibility:(bool)arg1;
