...
@interface SBFUserAuthenticationController : NSObject <SBFAuthenticationStatusProvider, SBFPasscodeFieldChangeObserver, SBFUserAuthenticationModelDelegate> {
...
+ (bool)_shouldTreatExtendedKeybagStateAsLocked;
...
- (void)_establishAuthenticationStateForInit;
...
- (void)_signUpForKeybagChangeNotifications;
...
- (void)_updateAuthenticationStateAndDateForLockState:(int)arg1 info:(id)arg2 options:(id)arg3;
...
- (id)initWithAssertionManager:(id)arg1 policy:(id)arg2 model:(id)arg3;
