...
@interface SPUISearchViewController : UIViewController <SPSearchAgentDelegate, SPUISearchFirstTimeViewControllerDelegate, SPUISearchHeaderDelegate, SPUISearchResultHandlerDelegate, SPUITableViewDelegate> {
...
- (bool)allowInternet;
- (void)authenticatedDeviceWithTouchID;
