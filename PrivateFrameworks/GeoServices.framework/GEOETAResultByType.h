...
@property (nonatomic, readonly) bool hasSummaryForPredictedDestination;
...
@property (nonatomic, retain) GEOFormattedString *summaryForPredictedDestination;
...
- (bool)hasStatus;
- (bool)hasSummaryForPredictedDestination;
...
- (void)setSummaryForPredictedDestination:(id)arg1;
...
- (id)summaryForPredictedDestination;
- (int)transportType;
