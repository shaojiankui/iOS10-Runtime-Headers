...
@property (nonatomic, retain) GEOAlightNotificationFeedback *alightNotificationFeedback;
@property (nonatomic) bool completedStep;
@property (nonatomic) double completionTimeStamp;
@property (nonatomic, readonly) bool hasAlightNotificationFeedback;
...
- (bool)hasAlightNotificationFeedback;
...
- (void)setAlightNotificationFeedback:(id)arg1;
