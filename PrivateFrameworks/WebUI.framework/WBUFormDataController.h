...
- (void)gatherAutoFillDisplayDataWithTextField:(id)arg1 wantCascadingAddressMatches:(bool)arg2 completionHandler:(id /* block */)arg3;
...
- (id)valuesForForm:(id)arg1 inFrame:(id)arg2 preferredLabel:(id)arg3 multiRoundAutoFillManager:(id)arg4 matches:(id*)arg5 contact:(id)arg6;
