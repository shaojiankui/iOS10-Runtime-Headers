...
- (void)activate;
- (void)addDeserializer:(struct NSObject { Class x1; }*)arg1;
...
- (id)getTapToRadarPunchOutForMissingResults;
...
- (void)retrieveImageDataForIdentifier:(id)arg1 inSection:(id)arg2 preferredSize:(struct CGSize { double x1; double x2; })arg3 completion:(id /* block */)arg4;
- (void)retrieveImageDataForResult:(id)arg1 inSection:(id)arg2 preferredSize:(struct CGSize { double x1; double x2; })arg3 completion:(id /* block */)arg4;
- (void)searchDaemonQuery:(id)arg1 addedResults:(struct NSObject { Class x1; }*)arg2;
