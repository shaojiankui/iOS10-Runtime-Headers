...
- (long long)matchScoreBetweenArray:(id)arg1 andQuery:(id)arg2 preferWholeFieldPrefix:(bool)arg3;
- (long long)matchScoreBetweenString:(id)arg1 andQuery:(id)arg2;
- (long long)matchScoreBetweenString:(id)arg1 andQuery:(id)arg2 preferWholeFieldPrefix:(bool)arg3;
...
- (bool)shouldComputeNormalizedCountForProperty:(id)arg1 query:(id)arg2;
- (id)simpleTitle;
- (id)sourceDomain;
- (id)subtitle;
- (id)templateName;
