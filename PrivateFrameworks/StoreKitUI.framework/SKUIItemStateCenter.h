...
- (void)_setNewItemIdentifiers:(id)arg1;
- (void)_setOwnedMessageExtensionItemIdentifiers:(id)arg1;
...
- (void)setItemsAsPurchasingState:(id)arg1 withCompletionBlock:(id /* block */)arg2;
