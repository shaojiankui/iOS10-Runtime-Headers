...
- (id)fetchKeys:(id)arg1 context:(id)arg2 qualityOfService:(long long)arg3 networkPriority:(long long)arg4 completionQueue:(id)arg5 completion:(id /* block */)arg6;
- (id)fetchKeysUnconditionally:(id)arg1 context:(id)arg2 qualityOfService:(long long)arg3 networkPriority:(long long)arg4 completionQueue:(id)arg5 completion:(id /* block */)arg6;
