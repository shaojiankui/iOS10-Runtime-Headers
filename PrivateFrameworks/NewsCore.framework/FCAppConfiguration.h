...
- (void)_extractCoverArticlesFromProtobufConfiguration:(id)arg1;
- (void)_extractEditorialChannelFromProtobufConfiguration:(id)arg1;
- (void)_extractEndpointConfigurationFromProtobufConfiguration:(id)arg1;
- (void)_extractFeedIDsFromProtobufConfiguration:(id)arg1;
- (void)_extractNotificationsConfigFromProtobufConfiguration:(id)arg1;
