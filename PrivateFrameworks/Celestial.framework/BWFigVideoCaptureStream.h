...
@property (readonly) struct CGPoint { double x1; double x2; } opticalCenter;
...
@property (nonatomic) bool streamingEnabledAsConfigured;
...
- (void)_prepareForStillImageCaptureWithBracketSettings:(id)arg1 captureType:(int)arg2 fromCMTimeMachine:(bool)arg3;
...
- (void)captureStillImageFromTimeMachine;
- (void)dealloc;
...
- (struct CGPoint { double x1; double x2; })opticalCenter;
- (id)portType;
- (void)prepareForStillImageCaptureFromFirmwareWithBracketSettings:(id)arg1 captureType:(int)arg2;
- (void)registerForFaceDetectionMetadata;
- (bool)sensorFormat;
- (id)sensorIDDictionary;
- (id)sensorIDString;
- (bool)setActiveFormatIndex:(long long)arg1;
...
- (void)setStreamingAsConfigured:(bool)arg1;
- (void)setStreamingEnabledAsConfigured:(bool)arg1;
...
- (bool)streaming;
- (bool)streamingEnabledAsConfigured;
- (id)supportedFormats;
