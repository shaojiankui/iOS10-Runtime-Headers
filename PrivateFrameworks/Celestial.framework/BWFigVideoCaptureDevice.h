...
@interface BWFigVideoCaptureDevice : BWCaptureDevice <BWZoomCompletionDelegate> {
    ...
    int  _fvcd_optionK;
    NSDictionary * _geometricDistortionCoefficientsByPortType;
    struct { 
        float redGain; 
        float greenGain; 
        float blueGain; 
...
@property (readonly) NSDictionary *geometricDistortionCoefficientsByPortType;
...
- (struct OpaqueFigSampleBufferProcessor { }*)_autofocusProcessor;
- (void)_captureStillImageBracketNow:(int)arg1 bracketSettings:(id)arg2 attachSushiRaw:(bool)arg3;
- (int)_captureStillImageNowOnStreamWithOptions:(id)arg1 flashMode:(bool)arg2;
- (void)_captureStillImageNowWithSettings:(id)arg1;
- (void)_captureStillImageNowWithTimeMachineType:(int)arg1 attachSushiRaw:(bool)arg2;
- (void)_captureStillImageWithFlashNowWithSushiRaw:(bool)arg1;
...
- (int)_currentStillImageSceneType;
...
- (void)_serviceStreamWithSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg1 fromCaptureStream:(id)arg2;
...
- (void)_updateStreamStateFromMetadataDictionary:(id)arg1;
...
- (id)geometricDistortionCoefficientsByPortType;
