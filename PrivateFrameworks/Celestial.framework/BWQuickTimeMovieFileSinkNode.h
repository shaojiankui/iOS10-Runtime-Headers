...
@interface BWQuickTimeMovieFileSinkNode : BWFileSinkNode {
    ...
    int  _irisVISCropPercentageDenominator;
    int  _irisVISCropPercentageNumerator;
...
- (int)irisVISCropPercentageDenominator;
- (int)irisVISCropPercentageNumerator;
...
- (void)setIrisVISCropPercentageDenominator:(int)arg1;
- (void)setIrisVISCropPercentageNumerator:(int)arg1;
