...
@interface BWStillImageCoordinatorNode : BWNode <BWBracketSettingsProvider, BWFigVideoCaptureStreamStillImageCaptureDelegate> {
    ...
    BWNodeOutput * _sicn_cachedHDROutput;
...
@property (nonatomic, readonly) BWNodeOutput *sicn_cachedHDROutput;
...
- (id)_outputForNodeInput:(id)arg1 captureType:(int)arg2;
