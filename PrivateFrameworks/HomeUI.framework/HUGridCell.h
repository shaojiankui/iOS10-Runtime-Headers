...
@property (nonatomic) unsigned long long currentIconDisplayStyle;
...
- (unsigned long long)currentIconDisplayStyle;
...
- (void)setCurrentIconDisplayStyle:(unsigned long long)arg1;
