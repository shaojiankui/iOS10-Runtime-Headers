...
@interface HUQuickControlContainerView : UIView {
    ...
    HUQuickControlPillButton * _alternateControlButton;
    ...
    HUQuickControlPillButton * _detailsButton;
...
@property (nonatomic, retain) HUQuickControlPillButton *alternateControlButton;
...
@property (nonatomic, retain) HUQuickControlPillButton *detailsButton;
