...
@interface DKHostRequest : NSObject {
    ...
    bool  _isCancelled;
    UIViewController * _presentableView;
...
@property (nonatomic, retain) UIViewController *presentableView;
...
- (id)init;
- (id)initWithDiagnostic:(id)arg1 completion:(id /* block */)arg2;
- (id)initWithDiagnostic:(id)arg1 completion:(id /* block */)arg2 presentableView:(id)arg3;
- (bool)isCancelled;
- (id)presentableView;
...
- (void)setPresentableView:(id)arg1;
