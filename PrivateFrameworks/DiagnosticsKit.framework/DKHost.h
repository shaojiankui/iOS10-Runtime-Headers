...
@interface DKHost : NSObject <DKAssertionDelegate, DKAssetResponder> {
...
- (void)beginDiagnosticWithIdentifier:(id)arg1 parameters:(id)arg2 presentableView:(id)arg3 completion:(id /* block */)arg4;
