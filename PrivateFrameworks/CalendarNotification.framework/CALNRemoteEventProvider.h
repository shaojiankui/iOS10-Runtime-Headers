...
@interface CALNRemoteEventProvider : CALNRemoteDataProvider {
    ...
    id /* block */  _cancelRefreshRequest;
...
@property (nonatomic, copy) id /* block */ cancelRefreshRequest;
...
@property (nonatomic, copy) id /* block */ requestRefresh;
...
- (void)_trackTTLAlertDirectionsEngagedEvent;
- (void)_trackTTLAlertFiredEvent;
...
- (void)setRequestRefresh:(id /* block */)arg1;
