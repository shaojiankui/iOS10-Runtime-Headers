...
@interface PXPhotosDetailsHeaderTileWidget : NSObject <PXChangeObserver, PXDiagnosticsEnvironment, PXPhotosDataSourceChangeObserver, PXPhotosDetailsHeaderTileLayoutDelegate, PXReusableObjectPoolDelegate, PXSlideshowSessionDelegate, PXTileSource, PXTilingControllerTransitionDelegate, PXTilingControllerZoomAnimationCoordinatorDelegate, PXUISlideshowViewTileDelegate, PXUIWidget, PXZoomAnimationObserverCoordinatorDelegate, UIGestureRecognizerDelegate> {
...
@property (setter=_setShowPlaceholder:, nonatomic) bool _showPlaceholder;
