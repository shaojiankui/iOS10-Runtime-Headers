...
@interface PKPassPaymentSummaryView : UIView <PKPassPaymentSummaryCellDelegate, UITableViewDataSource, UITableViewDelegate> {
    ...
    PKPaymentPass * _pass;
    PKPassPropertiesSummaryItem * _primaryPropertyItem;
    PKPassPropertiesSummaryItem * _secondaryPropertyItem;
