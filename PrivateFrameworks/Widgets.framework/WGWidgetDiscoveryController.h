...
- (void)invalidateWidgetListEditViewControllerStatusBarAssertion:(id)arg1;
- (long long)layoutModeForWidgetListEditViewController:(id)arg1;
- (id)newWidgetListEditViewController;
- (id)newWidgetListEditViewControllerStatusBarAssertion;
- (id)preferredViewControllerForPresentingFromViewController:(id)arg1;
...
- (void)requestUnlockWithCompletion:(id /* block */)arg1;
