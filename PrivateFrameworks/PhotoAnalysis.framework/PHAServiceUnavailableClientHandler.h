...
- (void)reclusterFacesWithThreshold:(id)arg1 withContext:(id)arg2 reply:(id /* block */)arg3;
...
- (void)requestIsShowingHolidayCalendarEventsWithContext:(id)arg1 reply:(id /* block */)arg2;
...
- (void)requestSetShowHolidayCalendarEvents:(bool)arg1 context:(id)arg2 reply:(id /* block */)arg3;
