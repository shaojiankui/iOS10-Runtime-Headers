...
@property (readonly) NSString *carrierBundlingStatusEligible;
@property (readonly) NSString *carrierBundlingStatusNeedsManualVerification;
@property (readonly) NSString *carrierBundlingStatusNotEligible;
@property (readonly) NSString *carrierBundlingStatusUnknown;
@property (readonly) NSString *carrierBundlingStatusUnlinked;
...
- (id)carrierBundlingStatusEligible;
- (id)carrierBundlingStatusNeedsManualVerification;
- (id)carrierBundlingStatusNotEligible;
- (id)carrierBundlingStatusUnknown;
- (id)carrierBundlingStatusUnlinked;
- (id)hasFamily;
- (id)hasFamilyMembers;
