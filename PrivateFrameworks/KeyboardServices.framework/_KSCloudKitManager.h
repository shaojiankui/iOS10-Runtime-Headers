...
- (void)_submitFetchRecordsOperation:(id)arg1 withPriority:(unsigned long long)arg2 completionHandler:(id /* block */)arg3 retryCount:(unsigned long long)arg4;
- (void)accountStatusDidChange:(id)arg1;
- (id)cloudKitContainer;
- (id)cloudKitDatabase;
- (void)dealloc;
- (void)fetchRecordsWithPriority:(unsigned long long)arg1 completionHandler:(id /* block */)arg2;
- (void)fetchRecordsWithPriority:(unsigned long long)arg1 completionHandler:(id /* block */)arg2 retryCount:(unsigned long long)arg3;
