...
- (void)invalidate;
- (id)predictionFilter;
- (void)predictionForCategories:(unsigned long long)arg1 consumer:(unsigned long long)arg2 criteria:(id)arg3 limit:(unsigned long long)arg4 completionHandler:(id /* block */)arg5;
- (void)predictionForCategories:(unsigned long long)arg1 consumer:(unsigned long long)arg2 criteria:(id)arg3 limit:(unsigned long long)arg4 prewarm:(bool)arg5 completionHandler:(id /* block */)arg6;
...
- (void)predictionForCategories:(unsigned long long)arg1 consumer:(unsigned long long)arg2 limit:(unsigned long long)arg3 prewarm:(bool)arg4 completionHandler:(id /* block */)arg5;
