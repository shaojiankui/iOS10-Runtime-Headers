...
- (id)initWithIdentifier:(id)arg1 accountIdentifier:(id)arg2 name:(id)arg3 productInfo:(id)arg4 destination:(id)arg5 version:(id)arg6 isResidentCapable:(bool)arg7 isRemoteGatewayCapable:(bool)arg8;
