...
@property (nonatomic, retain) NSMutableArray *vendorDetails;

+ (Class)vendorDetailsType;

- (void).cxx_destruct;
- (void)addVendorDetails:(id)arg1;
...
- (id)vendorDetails;
- (id)vendorDetailsAtIndex:(unsigned long long)arg1;
- (unsigned long long)vendorDetailsCount;
