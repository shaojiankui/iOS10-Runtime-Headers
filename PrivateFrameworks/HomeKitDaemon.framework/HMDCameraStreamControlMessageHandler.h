...
- (id)initWithWorkQueue:(id)arg1 streamSnapshotHandler:(id)arg2 messageSender:(id /* block */)arg3 settingsControlManager:(id)arg4 accessory:(id)arg5 streamManagementService:(id)arg6 msgDispatcher:(id)arg7 profileUniqueIdentifier:(id)arg8;
- (bool)isAvailable;
