...
@interface TVPlayerViewController : UIViewController <DurationDelegate, MoodDelegate, UIGestureRecognizerDelegate> {
    ...
    UIVisualEffectView * _backdropViewBadge;
    ...
    ProjectPlaceholder * _projectPlaceholder;
    UIActivityIndicatorView * _spinnerView;
}

@property bool aggFirstPlayback;
@property (nonatomic, retain) MiroAutoEditor *autoEditor;
@property (nonatomic, retain) UIVisualEffectView *backdropViewBadge;
...
@property (nonatomic, retain) ProjectPlaceholder *projectPlaceholder;
@property (nonatomic, retain) UIActivityIndicatorView *spinnerView;
@property (readonly) Class superclass;

- (void).cxx_destruct;
- (id)_aggdKeyForDifferenceInDuration:(double)arg1;
...
- (void)displayHeroImageAnimatedNoPlay;
...
- (void)setBackdropViewBadge:(id)arg1;
...
- (void)setProjectPlaceholder:(id)arg1;
