...
@interface MiroContentEditorViewController : UIViewController <MiroApplicationTestingEditorControlling, MiroAssetSuggestionsCollectionViewControllerDelegate, MiroEditorClipCellDataSource, MiroEditorClipCellDelegate, MiroEditorClipCollectionDataSource, MiroEditorClipCollectionDelegate, MiroTrimmerDelegate, UINavigationBarDelegate> {
    UIBarButtonItem * _addBarButtonItem;
    MiroAutoEditor * _autoEditor;
    UIBarButtonItem * _bottomPlayPauseBarButtonItem;
    UIToolbar * _bottomToolbar;
    RoundProgressViewController * _cloudDownloadProgress;
...
@property (nonatomic, retain) RoundProgressViewController *cloudDownloadProgress;
...
- (void)_configureConstraintsTopToolbarBackgroundRoundedRectAround:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1;
- (void)_configureConstraintsTopToolbarBackgroundRoundedRectAroundItems:(id)arg1;
- (void)_configureConstraintsTrimmerBetweenControlsUnderTopToolbar;
- (void)_configureConstraintsTrimmerFullWidthUnderTopToolbar;
- (void)_configureConstraintsTrimmerInlineBetweenLeft:(id)arg1 right:(id)arg2;
...
- (void)_someAssetsFailedDisplayAddAnyway:(id)arg1;
- (void)_updateAddButtonWhileAutoEditing;
...
- (void)setCloudDownloadProgress:(id)arg1;
...
- (id)trimmerMemoryIdentifier:(id)arg1;
