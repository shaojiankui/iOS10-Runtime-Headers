...
@interface _UIDocumentPickerViewServiceViewController : UINavigationController <_UIDocumentListControllerDelegate, _UIDocumentPickerOverviewDelegate, _UIDocumentPickerRemoteViewControllerContaining, _UIDocumentPickerViewController, _UIDocumentTargetSelectionControllerDelegate> {
