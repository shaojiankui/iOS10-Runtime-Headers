...
@property (nonatomic, retain) NSDictionary *featureScaling;
...
@property (nonatomic, retain) NSDictionary *localFeatures;
...
@property (nonatomic, retain) NSString *resultTemplate;
@property (nonatomic, retain) NSString *resultType;
@property (readonly) <SearchUIResult> *searchUIResult;
...
@property (nonatomic, retain) NSString *titleNote;
@property (nonatomic, retain) NSNumber *titleNoteSize;
@property (nonatomic) unsigned long long topHit;
@property (nonatomic, retain) NSDictionary *topicDistribution;
