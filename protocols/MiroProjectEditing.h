...
- (void)addClipsForAssets:(NSArray *)arg1 hintAddedIndexes:(id*)arg2;
...
- (void)removeClip:(id <MiroClip>)arg1 hintSnapToIndex:(unsigned long long*)arg2;
