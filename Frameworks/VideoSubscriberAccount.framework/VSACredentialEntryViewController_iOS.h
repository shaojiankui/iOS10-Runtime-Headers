...
@interface VSACredentialEntryViewController_iOS : ACUIViewController <VSACredentialEntryViewController> {
    ...
    <VSACredentialEntryViewControllerDelegate> * _delegate;
...
@property (nonatomic) <VSACredentialEntryViewControllerDelegate> *delegate;
...
@property (nonatomic, retain) VSACredentialEntryViewModel *viewModel;
