...
@interface _MPMediaLibraryEntityTranslationContext : NSObject <MPMediaLibraryEntityTranslatingContext> {
    ...
    NSArray * _matchingItemIdentifiers;
...
@property (nonatomic, retain) NSArray *matchingItemIdentifiers;
