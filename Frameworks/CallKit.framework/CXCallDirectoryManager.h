...
- (id)connection;
- (void)dealloc;
- (void)firstIdentificationEntriesForEmailAddresses:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)firstIdentificationEntriesForPhoneNumbers:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)firstIdentificationEntryForEmailAddress:(id)arg1 completionHandler:(id /* block */)arg2;
