...
@property (nonatomic, readonly, copy) NSArray *channelIDs;
...
@property (nonatomic, readonly, copy) NSString *identityProviderDisplayName;
...
@property (nonatomic, readonly, copy) NSArray *postalCodes;
