...
@property (nonatomic, readonly, copy) NSString *SAMLAuthenticationResponse;
...
+ (id)vsa_credentialWithSAMLAuthenticationResponse:(id)arg1;

- (id)SAMLAuthenticationResponse;
