...
@interface NSDictionary : NSObject <CKDParsedObject, CSCoderEncoder, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding, PHFetchDictionaryAccessing, PQLBindable>

@property (nonatomic, readonly) NSNumber *__im_associatedMessageContentType;
@property (nonatomic, readonly) NSDate *__im_associatedMessageDate;
@property (nonatomic, readonly) NSString *__im_associatedMessageSenderHandle;
...
- (id)vsa_arrayForKey:(id)arg1;
- (id)vsa_dictionaryForKey:(id)arg1;
- (id)vsa_numberForKey:(id)arg1;
- (id)vsa_objectOfClass:(Class)arg1 forKey:(id)arg2;
- (id)vsa_stringForKey:(id)arg1;
...
- (id)__im_associatedMessageDate;
- (id)__im_associatedMessageSenderHandle;
