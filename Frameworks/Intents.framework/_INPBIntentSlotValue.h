...
@interface _INPBIntentSlotValue : PBCodable <NSCopying> {
    ...
    struct { 
        ...
        unsigned long long count; 
        unsigned long long size; 
    }  _PayloadTemperatureModes;
    struct { 
        int *list; 
        unsigned long long count; 
        unsigned long long size; 
    }  _PayloadTemperatureUnits;
    struct { 
        int *list; 
        unsigned long long count; 
        unsigned long long size; 
...
@property (nonatomic, readonly) int*PayloadTemperatureModes;
@property (nonatomic, readonly) unsigned long long PayloadTemperatureModesCount;
@property (nonatomic, readonly) int*PayloadTemperatureUnits;
@property (nonatomic, readonly) unsigned long long PayloadTemperatureUnitsCount;
...
- (int*)PayloadTemperatureModes;
- (unsigned long long)PayloadTemperatureModesCount;
- (int)PayloadTemperatureUnitAtIndex:(unsigned long long)arg1;
- (int*)PayloadTemperatureUnits;
- (unsigned long long)PayloadTemperatureUnitsCount;
