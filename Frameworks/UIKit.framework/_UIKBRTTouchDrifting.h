...
@property (nonatomic) bool leftDriftLocked;
...
@property (nonatomic) bool rightDriftLocked;
...
@property (nonatomic) struct CGSize { double x1; double x2; } touchError;
...
- (void)setLeftDriftLocked:(bool)arg1;
...
- (void)setRightDriftLocked:(bool)arg1;
