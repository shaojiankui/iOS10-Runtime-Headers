...
@interface _UIAlertControllerView : UIView <UIGestureRecognizerDelegatePrivate, UIInterfaceActionHandlerInvocationDelegate, UIScrollViewDelegate> {
    ...
    UIAlertControllerInterfaceActionGroupView * _discreteCancelActionGroupView;
    ...
    UIAlertControllerInterfaceActionGroupView * _mainInterfaceActionsGroupView;
...
- (id)_orderedPresentableAlertActionViewRepresentations;
- (id)_orderedPresentableAlertActions;
