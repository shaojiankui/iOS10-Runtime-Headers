...
- (void)_connectScreen;
- (id)_contentSizeCategoryTraits;
- (id)_contentSizeCategoryTraitsWithPreferredContentSizeCategory:(id)arg1;
- (id)_contentSizeCategoryTraitsWithPreferredContentSizeCategoryPreferences;
...
- (void)_updateContentSizeCategoryTraits:(id)arg1;
...
- (void)_updateTraits;
- (void)_updateTraitsWithPreferredContentSizeCategory:(id)arg1;
- (void)_updateTraitsWithPreferredContentSizeCategoryPreferences;
