...
@interface UIPrintPreviewViewController : UICollectionViewController <PageRangeDelegate, UICollectionViewDelegate, UIDocumentInteractionControllerDelegate, UIGestureRecognizerDelegate, UINavigationControllerDelegate, UIScrollViewDelegate, UIViewControllerPreviewingDelegate_Private> {
...
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })validRenderRange;
