...
@interface UIScrollView : UIView <NSCoding, UIGestureRecognizerDelegate, UIRefreshControlHosting, UIScrollViewDelayedTouchesBeganGestureRecognizerClient, _UIScrollToTopView> {
