...
@interface UIActivityViewController : UIViewController <UIActionSheetPresentationControllerDelegate, UIAlertControllerContaining, UIViewControllerRestoration, _UIActivityHelperDelegate, _UIActivityViewControllerContentControllerDelegate> {
