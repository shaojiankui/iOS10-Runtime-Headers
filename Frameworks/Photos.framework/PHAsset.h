...
@property (nonatomic, readonly) double miro_IrisVideoDurationGuesstimate;
...
+ (id)_fetchCuratedAssetInAssetCollection:(id)arg1 referenceAsset:(id)arg2 onlyKey:(bool)arg3;
...
+ (id)miro_filterRanges:(id)arg1 forMemory:(id)arg2;
...
- (bool)_legacyHasLocallyAvailableUsableMedia;
...
- (int)downloadResource:(id)arg1 withProgressHandler:(id /* block */)arg2;
...
- (id)miro_rangesWithType:(unsigned long long)arg1 forMemory:(id)arg2;
...
- (id)miro_transientRangesWithType:(unsigned long long)arg1 forMemory:(id)arg2;
...
- (struct CGSize { double x1; double x2; })vcp_thumbnailSize;
