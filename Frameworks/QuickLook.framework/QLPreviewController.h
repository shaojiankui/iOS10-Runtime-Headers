...
@interface QLPreviewController : UIViewController <QLPreviewControllerStateProtocol, QLPreviewItemProvider, UIGestureRecognizerDelegate, UINavigationControllerDelegate, UIPageViewControllerDelegate, UIScrollViewDelegate, UIViewControllerTransitioningDelegate> {
