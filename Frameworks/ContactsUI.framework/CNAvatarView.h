...
@property (nonatomic, retain) NSLayoutConstraint *likenessViewSizeConstraint;
...
@property (nonatomic, retain) UIView *subviewsContainer;
...
@property (nonatomic) bool useHalfSizeMongramsAndImages;
...
- (void)setLikenessViewSizeConstraint:(id)arg1;
...
- (void)setSubviewsContainer:(id)arg1;
