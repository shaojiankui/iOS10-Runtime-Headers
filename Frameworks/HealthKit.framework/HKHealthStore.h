...
- (void)_wheelchairUseDidChangeTo:(long long)arg1;
...
- (void)fetchSharedFitnessFriendsActivityDataWithCompletion:(id /* block */)arg1;
...
- (void)sendFitnessFriendInviteRequestToDestination:(id)arg1 addressBookGUID:(id)arg2 serviceIdentifier:(id)arg3 completion:(id /* block */)arg4;
