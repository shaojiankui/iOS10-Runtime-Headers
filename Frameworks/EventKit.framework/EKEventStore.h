...
@interface EKEventStore : NSObject <EKDaemonConnection> {
    ...
    NSObject<OS_dispatch_queue> * _keyBagLockStatusChangedQueue;
...
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *keyBagLockStatusChangedQueue;
...
- (id)keyBagLockStatusChangedQueue;
...
- (void)setKeyBagLockStatusChangedQueue:(id)arg1;
