...
@interface PUPhotosGridViewController : UICollectionViewController <PHAssetCollectionDataSource, PLDismissableViewController, PLNavigableAssetContainerViewController, PUAutoScrollerDelegate, PUCollectionViewReorderDelegate, PUDeletePhotosActionControllerDelegate, PUOneUpPresentationHelperDelegate, PUPhotosGlobalFooterViewDelegate, PUPhotosSharingViewControllerDelegate, PUScrollViewSpeedometerDelegate, PUSessionInfoObserver, PUSlideshowViewControllerDelegate, PUStackedAlbumControllerTransition, PUSwipeSelectionManagerDataSource, PUSwipeSelectionManagerDelegate, PUTimelineControllerDelegate, PXPhotosDataSourceChangeObserver, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate, _UISettingsKeyObserver> {
...
@property (setter=_setDateScrubberConstraints:, nonatomic, retain) NSArray *_dateScrubberConstraints;
...
@property (setter=_setLibraryScrubberConstraints:, nonatomic, retain) NSArray *_libraryScrubberConstraints;
...
@property (setter=_setTimelineController:, nonatomic, retain) PUTimelineController *_timelineController;
...
- (id)_libraryScrubberConstraints;
...
- (void)_setDateScrubberConstraints:(id)arg1;
...
- (void)_setLibraryScrubberConstraints:(id)arg1;
...
- (void)_setTimelineController:(id)arg1;
