...
@interface PUPhotosSiriSearchPresenter : NSObject <PUSearchResultsDataSourceChangeObserver> {
    ...
    PUFilteredMomentsDataSource * _photoCollections;
    bool  _presenting;
    UIViewController * _sCurrentVisibleController;
    PUNavigationController * _searchResultsNav;
    PUFilteredMomentsViewController * _searchResultsViewController;
...
@property (nonatomic, retain) PUFilteredMomentsDataSource *photoCollections;
...
@property (nonatomic, retain) PUFilteredMomentsViewController *searchResultsViewController;
