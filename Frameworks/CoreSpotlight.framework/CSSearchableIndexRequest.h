...
- (/* Warning: Unrecognized filer type: '' using 'void*' */ void*)requestID:(SEL)arg1;
...
- (void)setRequestID:(void *)arg1; // needs 1 arg types, found 2: /* Warning: Unrecognized filer type: '' using 'void*' */ void*, unsigned int
