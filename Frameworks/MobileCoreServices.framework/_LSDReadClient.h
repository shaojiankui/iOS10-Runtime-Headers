...
- (void)getLocalizationDictionaryForTypeWithIdentifier:(id)arg1 UUID:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)getLocalizedNameWithBundleType:(id)arg1 bundleIdentifier:(id)arg2 bundleUUID:(id)arg3 context:(id)arg4 shortNameOnly:(bool)arg5 completionHandler:(id /* block */)arg6;
- (void)getResourceValuesForKeys:(id)arg1 URL:(id)arg2 completionHandler:(id /* block */)arg3;
- (void)getServerStatusWithCompletionHandler:(id /* block */)arg1;
- (void)getServerStoreWithCompletionHandler:(id /* block */)arg1;
- (void)getShouldLogContextInitCallsWithCompletionHandler:(id /* block */)arg1;
