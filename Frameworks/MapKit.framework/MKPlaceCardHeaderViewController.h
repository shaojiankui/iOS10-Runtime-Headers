...
@interface MKPlaceCardHeaderViewController : MKPlaceSectionViewController <MKLocationManagerObserver, MKQuickRouteConfigurableView, MKQuickRouteManagerDelegate, MKQuickRouteTransportTypeFinding, MKStackingViewControllerFixedHeightAware, _MKInfoCardChildViewControllerAnalyticsDelegate> {
    UIButton * _actionButton;
    NSLayoutConstraint * _actionButtonHeightConstraint;
    id /* block */  _actionButtonResponseBlock;
...
- (void)setActionButtonText:(id)arg1 responseBlock:(id /* block */)arg2;
