...
- (void)_setCoordinates:(struct CLLocationCoordinate2D { double x1; double x2; }*)arg1 count:(unsigned long long)arg2;
- (void)_setPoints:(struct { double x1; double x2; }*)arg1 count:(unsigned long long)arg2;
- (void)_wrapAroundTheDateline:(struct CLLocationCoordinate2D { double x1; double x2; }*)arg1 count:(unsigned long long)arg2;
